...
## [2.3.2-dev+9] - Unreleased
## [2.3.2-dev+8] - Unreleased
## [2.3.2-dev+7] - Unreleased
## [2.3.2-dev+6] - Unreleased
### Changed
- Update update script for improved version handling and user feedback.

## [2.3.2-dev+5] - Unreleased
### Changed
- Update installation instructions in README, enhance update script handling in install.sh.
...
## [2.3.2-dev+2] - Unreleased
### Added
- Remove redundant executable permission setting for the install script.

## [2.3.2-dev+1] - Unreleased
### Added
-  Enhance update process in README with new installation script options and features.

## [2.3.2-dev] - Unreleased
### Added
- Add update.sh to update script.

## [2.3.1-dev+2] - Unreleased
### Added
- Add return option in menus
